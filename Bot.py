...
def start(message):
    ...
    bot.send_message(
        ...
        "Интересуетесь ассортиментом ноутбуков со скидкой в магазине Электросила?",
        reply_markup=markup,
    )
...
def handle_message(message):
    ...
    if message.chat.type == "private":
        if message.text == "Конечно":
            ...
            base_url = "https://sila.by/catalog/noutbuki/asort/5/paramsort/33/all/city_272,shop_all"
